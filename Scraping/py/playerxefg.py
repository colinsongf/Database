...
f.write('player_id,player_name,player_size,team_name,team_id,location,game_id,date,atb3_pts,atb3_attempt,atb3_pps,c3_pts,c3_attempt,c3_pps,mid_pts,mid_attempt,mid_pps,ra_pts,ra_attempt,ra_pps,paint_pts,paint_attempt,paint_pps,total_pps'+'\n')
	...
	for gameid in pd.unique(df_shots['GAME_ID'].values):
		...
		for players in playerlist:
			...
			if player_name == 'nan':
				...
				writer.writerow([players,player_name,playersize,team_name,teamid,location,gameid,date,player_atb3_pts,player_atb3_at,player_atb3_pps,player_c3_pts,player_c3_at,player_c3_pps,player_mid_pts,player_mid_at,player_mid_pps,player_ra_pts,player_ra_at,player_ra_pps,player_paint_pts,player_paint_at,player_paint_pps,player_total_pps])
